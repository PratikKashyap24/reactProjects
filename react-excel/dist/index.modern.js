...
const ReactExcel = props => {
  ...
  const createTableHeader = firstRow => {
    return /*#__PURE__*/React.createElement("thead", null, /*#__PURE__*/React.createElement("tr", null, Object.values(firstRow).map((cell, idx) => /*#__PURE__*/React.createElement("th", {
      key: idx,
  ...
  const createTableBody = rowArray => {
    ...
    return /*#__PURE__*/React.createElement("tbody", null, rows.map((row, id) => /*#__PURE__*/React.createElement("tr", {
      key: id
    }, row.map((cell, idx) => /*#__PURE__*/React.createElement("td", {
      key: idx,
      contentEditable: true,
      suppressContentEditableWarning: true,
      onBlur: e => {
  ...
  const handleClick = (e, id) => {
    const sheet = parsedData.find(o => Object.keys(o).includes(e.target.value));
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: reactExcelClassName
  }, /*#__PURE__*/React.createElement("div", null, sheetNames.map((name, idx) => /*#__PURE__*/React.createElement("button", {
    key: idx,
    value: name,
    onClick: e => handleClick(e, idx),
    className: `${activeSheet === idx ? `${activeSheetClassName}` : ''}`
  }, name))), currentSheet && /*#__PURE__*/React.createElement("table", null, createTableHeader(Object.values(currentSheet)[0][0]), createTableBody(Object.values(currentSheet)[0])));
};
...
export { ReactExcel, generateObjects, readFile };
